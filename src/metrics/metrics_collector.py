    ...
    def record_end(self, stage: str) -> None:
        ...
        with self._lock:
            ...
            self._metrics_data['stage_timings'][stage] = {
                ...
                'start_time': datetime.fromtimestamp(self._run_start_time + (start_time - self._run_start_time)).isoformat(),
                'end_time': datetime.fromtimestamp(self._run_start_time + (end_time - self._run_start_time)).isoformat()
            }
