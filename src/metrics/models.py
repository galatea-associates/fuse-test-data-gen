...
class PerformanceMetrics:
    ...
    and writer output generation. Used for performance analysis and optimization.
    """
...
class ThroughputMetrics:
    ...
    generation runs. Critical for performance optimization and capacity planning.
    """
...
class ComparisonMetrics:
    ...
    Provides comparative analysis capabilities between multiple generation runs,
    including delta calculations, performance rankings, and trend analysis.
    Used by the dashboard for historical performance comparison and optimization guidance.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            delta_analysis: Comparison deltas against baseline or previous runs
